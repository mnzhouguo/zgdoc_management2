<template><div><ul>
<li><a href="#1-hello-vuepress">1. Hello VuePress</a>
<ul>
<li><a href="#11-%E6%A6%82%E8%BF%B0">1.1. 概述</a></li>
<li><a href="#12-%E6%A0%B8%E5%BF%83%E6%A6%82%E5%BF%B5">1.2. 核心概念</a></li>
<li><a href="#13-%E5%BA%95%E5%B1%82%E5%8E%9F%E7%90%86">1.3. 底层原理</a>
<ul>
<li><a href="#131-%E7%9B%AE%E5%BD%95%E7%BB%93%E6%9E%84">1.3.1. 目录结构</a></li>
<li><a href="#132-%E7%8A%B6%E6%80%81%E6%A8%A1%E5%9E%8B">1.3.2. 状态模型</a></li>
<li><a href="#133-%E5%AD%98%E5%82%A8%E6%A8%A1%E5%9E%8B">1.3.3. 存储模型</a></li>
<li><a href="#134-%E5%88%86%E6%94%AF%E7%AE%A1%E7%90%86">1.3.4. 分支管理</a></li>
</ul>
</li>
<li><a href="#14-%E4%BD%BF%E7%94%A8%E5%AE%9E%E8%B7%B5">1.4. 使用实践</a>
<ul>
<li><a href="#141-git%E5%AE%89%E8%A3%85%E4%B8%8E%E9%85%8D%E7%BD%AE">1.4.1. git安装与配置</a></li>
<li><a href="#142-ssh%E8%BF%9C%E7%A8%8B%E8%AE%BF%E9%97%AE">1.4.2. SSH远程访问</a></li>
<li><a href="#143-%E8%BF%9C%E7%A8%8B%E4%BB%93%E5%BA%93clone%E5%88%B0%E6%9C%AC%E5%9C%B0">1.4.3. 远程仓库clone到本地</a></li>
<li><a href="#144-%E6%9C%AC%E5%9C%B0%E4%BB%93%E5%BA%93%E6%8F%90%E4%BA%A4%E5%88%B0github">1.4.4. 本地仓库提交到GitHub</a></li>
<li><a href="#145-%E5%B8%B8%E7%94%A8%E5%91%BD%E4%BB%A4">1.4.5. 常用命令</a></li>
<li><a href="#146-%E8%8E%B7%E5%8F%96%E8%BF%9C%E7%A8%8B%E6%9B%B4%E6%96%B0">1.4.6. 获取远程更新</a></li>
<li><a href="#147-%E5%9F%BA%E4%BA%8Emaster%E5%88%9B%E5%BB%BA%E6%96%B0%E5%88%86%E6%94%AF">1.4.7. 基于master创建新分支</a></li>
</ul>
</li>
<li><a href="#15-%E5%B8%B8%E8%A7%81%E9%97%AE%E9%A2%98">1.5. 常见问题</a>
<ul>
<li><a href="#151-git-failed-to-connect-to-githubcom-port-443">1.5.1. git Failed to connect to github.com port 443</a></li>
<li><a href="#152-error-src-refspec-main-does-not-match-any">1.5.2. error: src refspec main does not match any</a></li>
<li><a href="#153-error-failed-to-push-some-refs-to">1.5.3. error: failed to push some refs to</a></li>
<li><a href="#154-openssl-ssl_read-connection-was-reset-errno-10054">1.5.4. OpenSSL SSL_read: Connection was reset, errno 10054</a></li>
<li><a href="#155-fatal-couldnt-find-remote-ref-master">1.5.5. fatal: Couldn't find remote ref master</a></li>
<li><a href="#156-another-git-process-seems-to-be-running-in-this-repository">1.5.6. Another git process seems to be running in this repository</a></li>
</ul>
</li>
</ul>
</li>
</ul>
<h1 id="_1-hello-vuepress" tabindex="-1"><a class="header-anchor" href="#_1-hello-vuepress" aria-hidden="true">#</a> 1. Hello VuePress</h1>
<h2 id="_1-1-概述" tabindex="-1"><a class="header-anchor" href="#_1-1-概述" aria-hidden="true">#</a> 1.1. 概述</h2>
...
<p>对于大部分程序员，平时的使用场景可能都只是在各个插件之上，进行简单的提交，合并等操作。而对于初学着会对git的命令感到困惑，一般使用死记硬背的方式去学习，这样导致一旦长时间不用就会忘记，或者出现一些异常情况就不知道如何处理。
...
<h2 id="_1-2-核心概念" tabindex="-1"><a class="header-anchor" href="#_1-2-核心概念" aria-hidden="true">#</a> 1.2. 核心概念</h2>
<ul>
...
<h2 id="_1-3-底层原理" tabindex="-1"><a class="header-anchor" href="#_1-3-底层原理" aria-hidden="true">#</a> 1.3. 底层原理</h2>
<h3 id="_1-3-1-目录结构" tabindex="-1"><a class="header-anchor" href="#_1-3-1-目录结构" aria-hidden="true">#</a> 1.3.1. 目录结构</h3>
...
<h3 id="_1-3-2-状态模型" tabindex="-1"><a class="header-anchor" href="#_1-3-2-状态模型" aria-hidden="true">#</a> 1.3.2. 状态模型</h3>
...
<h3 id="_1-3-3-存储模型" tabindex="-1"><a class="header-anchor" href="#_1-3-3-存储模型" aria-hidden="true">#</a> 1.3.3. 存储模型</h3>
<blockquote>
...
<h3 id="_1-3-4-分支管理" tabindex="-1"><a class="header-anchor" href="#_1-3-4-分支管理" aria-hidden="true">#</a> 1.3.4. 分支管理</h3>
<h2 id="_1-4-使用实践" tabindex="-1"><a class="header-anchor" href="#_1-4-使用实践" aria-hidden="true">#</a> 1.4. 使用实践</h2>
<h3 id="_1-4-1-git安装与配置" tabindex="-1"><a class="header-anchor" href="#_1-4-1-git安装与配置" aria-hidden="true">#</a> 1.4.1. git安装与配置</h3>
<ul>
<li>配置git信息</li>
</ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-4-2-ssh远程访问" tabindex="-1"><a class="header-anchor" href="#_1-4-2-ssh远程访问" aria-hidden="true">#</a> 1.4.2. SSH远程访问</h3>
...
<h3 id="_1-4-3-远程仓库clone到本地" tabindex="-1"><a class="header-anchor" href="#_1-4-3-远程仓库clone到本地" aria-hidden="true">#</a> 1.4.3. 远程仓库clone到本地</h3>
<ul>
<li>
...
<h3 id="_1-4-4-本地仓库提交到github" tabindex="-1"><a class="header-anchor" href="#_1-4-4-本地仓库提交到github" aria-hidden="true">#</a> 1.4.4. 本地仓库提交到GitHub</h3>
...
<h3 id="_1-4-5-常用命令" tabindex="-1"><a class="header-anchor" href="#_1-4-5-常用命令" aria-hidden="true">#</a> 1.4.5. 常用命令</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-4-6-获取远程更新" tabindex="-1"><a class="header-anchor" href="#_1-4-6-获取远程更新" aria-hidden="true">#</a> 1.4.6. 获取远程更新</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-4-7-基于master创建新分支" tabindex="-1"><a class="header-anchor" href="#_1-4-7-基于master创建新分支" aria-hidden="true">#</a> 1.4.7. 基于master创建新分支</h3>
...
<h2 id="_1-5-常见问题" tabindex="-1"><a class="header-anchor" href="#_1-5-常见问题" aria-hidden="true">#</a> 1.5. 常见问题</h2>
<h3 id="_1-5-1-git-failed-to-connect-to-github-com-port-443" tabindex="-1"><a class="header-anchor" href="#_1-5-1-git-failed-to-connect-to-github-com-port-443" aria-hidden="true">#</a> 1.5.1. git Failed to connect to github.com port 443</h3>
<p>-[2] to include in what will be committed</p>
<h3 id="_1-5-2-error-src-refspec-main-does-not-match-any" tabindex="-1"><a class="header-anchor" href="#_1-5-2-error-src-refspec-main-does-not-match-any" aria-hidden="true">#</a> 1.5.2. error: src refspec main does not match any</h3>
<h3 id="_1-5-3-error-failed-to-push-some-refs-to" tabindex="-1"><a class="header-anchor" href="#_1-5-3-error-failed-to-push-some-refs-to" aria-hidden="true">#</a> 1.5.3. error: failed to push some refs to</h3>
...
<h3 id="_1-5-4-openssl-ssl-read-connection-was-reset-errno-10054" tabindex="-1"><a class="header-anchor" href="#_1-5-4-openssl-ssl-read-connection-was-reset-errno-10054" aria-hidden="true">#</a> 1.5.4. OpenSSL SSL_read: Connection was reset, errno 10054</h3>
<p><strong>产生原因：</strong></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-5-5-fatal-couldn-t-find-remote-ref-master" tabindex="-1"><a class="header-anchor" href="#_1-5-5-fatal-couldn-t-find-remote-ref-master" aria-hidden="true">#</a> 1.5.5. fatal: Couldn't find remote ref master</h3>
<h3 id="_1-5-6-another-git-process-seems-to-be-running-in-this-repository" tabindex="-1"><a class="header-anchor" href="#_1-5-6-another-git-process-seems-to-be-running-in-this-repository" aria-hidden="true">#</a> 1.5.6. Another git process seems to be running in this repository</h3>
...
<p>https://www.pudn.com/news/628351af3b39c078242ddbd5.html</p>
</div></template>

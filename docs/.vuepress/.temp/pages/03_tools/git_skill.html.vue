<template><div><p><strong>目录结构</strong></p>
<nav class="table-of-contents"><ul><li><router-link to="#_1-概述">1. 概述</router-link></li><li><router-link to="#_2-核心概念">2. 核心概念</router-link></li><li><router-link to="#_3-底层原理">3. 底层原理</router-link><ul><li><router-link to="#_3-1-目录结构">3.1. 目录结构</router-link></li><li><router-link to="#_3-2-状态模型">3.2. 状态模型</router-link></li><li><router-link to="#_3-3-存储模型">3.3. 存储模型</router-link></li><li><router-link to="#_3-4-分支管理">3.4. 分支管理</router-link></li></ul></li><li><router-link to="#_4-使用实践">4. 使用实践</router-link><ul><li><router-link to="#_4-1-git安装与配置">4.1. git安装与配置</router-link></li><li><router-link to="#_4-2-ssh远程访问">4.2. SSH远程访问</router-link></li><li><router-link to="#_4-3-远程仓库clone到本地">4.3. 远程仓库clone到本地</router-link></li><li><router-link to="#_4-4-本地仓库提交到github">4.4. 本地仓库提交到GitHub</router-link></li><li><router-link to="#_4-5-常用命令">4.5. 常用命令</router-link></li><li><router-link to="#_4-6-获取远程更新">4.6. 获取远程更新</router-link></li><li><router-link to="#_4-7-基于master创建新分支">4.7. 基于master创建新分支</router-link></li></ul></li><li><router-link to="#_5-常见问题">5. 常见问题</router-link><ul><li><router-link to="#_5-1-git-failed-to-connect-to-github-com-port-443">5.1. git Failed to connect to github.com port 443</router-link></li><li><router-link to="#_5-2-error-src-refspec-main-does-not-match-any">5.2. error: src refspec main does not match any</router-link></li><li><router-link to="#_5-3-error-failed-to-push-some-refs-to">5.3. error: failed to push some refs to <url></router-link></li><li><router-link to="#_5-4-openssl-ssl-read-connection-was-reset-errno-10054">5.4. OpenSSL SSL_read: Connection was reset, errno 10054</router-link></li><li><router-link to="#_5-5-fatal-couldn-t-find-remote-ref-master">5.5. fatal: Couldn&#39;t find remote ref master</router-link></li><li><router-link to="#another-git-process-seems-to-be-running-in-this-repository">Another git process seems to be running in this repository</router-link></li></ul></li><li><router-link to="#_6-参考文档">6. 参考文档</router-link></li></ul></nav>
<ul>
<li><a href="#1-%E6%A6%82%E8%BF%B0">1. 概述</a></li>
<li><a href="#2-%E6%A0%B8%E5%BF%83%E6%A6%82%E5%BF%B5">2. 核心概念</a></li>
<li><a href="#3-%E5%BA%95%E5%B1%82%E5%8E%9F%E7%90%86">3. 底层原理</a>
<ul>
<li><a href="#31-%E7%9B%AE%E5%BD%95%E7%BB%93%E6%9E%84">3.1. 目录结构</a></li>
<li><a href="#32-%E7%8A%B6%E6%80%81%E6%A8%A1%E5%9E%8B">3.2. 状态模型</a></li>
<li><a href="#33-%E5%AD%98%E5%82%A8%E6%A8%A1%E5%9E%8B">3.3. 存储模型</a></li>
<li><a href="#34-%E5%88%86%E6%94%AF%E7%AE%A1%E7%90%86">3.4. 分支管理</a></li>
</ul>
</li>
<li><a href="#4-%E4%BD%BF%E7%94%A8%E5%AE%9E%E8%B7%B5">4. 使用实践</a>
<ul>
<li><a href="#41-git%E5%AE%89%E8%A3%85%E4%B8%8E%E9%85%8D%E7%BD%AE">4.1. git安装与配置</a></li>
<li><a href="#42-ssh%E8%BF%9C%E7%A8%8B%E8%AE%BF%E9%97%AE">4.2. SSH远程访问</a></li>
<li><a href="#43-%E8%BF%9C%E7%A8%8B%E4%BB%93%E5%BA%93clone%E5%88%B0%E6%9C%AC%E5%9C%B0">4.3. 远程仓库clone到本地</a></li>
<li><a href="#44-%E6%9C%AC%E5%9C%B0%E4%BB%93%E5%BA%93%E6%8F%90%E4%BA%A4%E5%88%B0github">4.4. 本地仓库提交到GitHub</a></li>
<li><a href="#45-%E5%B8%B8%E7%94%A8%E5%91%BD%E4%BB%A4">4.5. 常用命令</a></li>
<li><a href="#46-%E8%8E%B7%E5%8F%96%E8%BF%9C%E7%A8%8B%E6%9B%B4%E6%96%B0">4.6. 获取远程更新</a></li>
<li><a href="#47-%E5%9F%BA%E4%BA%8Emaster%E5%88%9B%E5%BB%BA%E6%96%B0%E5%88%86%E6%94%AF">4.7. 基于master创建新分支</a></li>
</ul>
</li>
<li><a href="#5-%E5%B8%B8%E8%A7%81%E9%97%AE%E9%A2%98">5. 常见问题</a>
<ul>
<li><a href="#51-git-failed-to-connect-to-githubcom-port-443">5.1. git Failed to connect to github.com port 443</a></li>
<li><a href="#52-error-src-refspec-main-does-not-match-any">5.2. error: src refspec main does not match any</a></li>
<li><a href="#53-error-failed-to-push-some-refs-to-url">5.3. error: failed to push some refs to <url></a></li>
<li><a href="#54-openssl-ssl_read-connection-was-reset-errno-10054">5.4. OpenSSL SSL_read: Connection was reset, errno 10054</a></li>
<li><a href="#55-fatal-couldnt-find-remote-ref-master">5.5. fatal: Couldn't find remote ref master</a></li>
<li><a href="#another-git-process-seems-to-be-running-in-this-repository">Another git process seems to be running in this repository</a></li>
</ul>
</li>
<li><a href="#6-%E5%8F%82%E8%80%83%E6%96%87%E6%A1%A3">6. 参考文档</a></li>
</ul>
...
<p><img src="D:\code\doc\zgdoc-technology\documents\03_tools\image\v2-ad80ca99a26a25e8f10aa206cd122aad_720w.jpg" alt="img"></p>
...
<p><img src="D:\code\doc\zgdoc-technology\documents\03_tools\image\data-model-3.png" alt="img"></p>
<ul>
<li>
...
<img src="D:\code\doc\zgdoc-technology\documents\03_tools\image\wps2.jpg" alt="img"></p>
...
<p><a href="https://blog.csdn.net/qq_37808895/article/details/90733824" target="_blank" rel="noopener noreferrer">https://blog.csdn.net/qq_37808895/article/details/90733824<ExternalLinkIcon/></a>
<a href="https://git-scm.com/book/zh/v2/Git-%E5%86%85%E9%83%A8%E5%8E%9F%E7%90%86-Git-%E5%AF%B9%E8%B1%A1" target="_blank" rel="noopener noreferrer">Git - Git 对象 (git-scm.com)<ExternalLinkIcon/></a></p>
</div></template>
